...
There's also an abundance of help, tutorials and examples.
...
Now delete the "x" and paste the whole source code file from a text editor like Notepad into the editor window.
